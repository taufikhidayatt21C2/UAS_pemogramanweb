...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nik && $nama && $alamat && $posisi) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update karyawan set nik = '$nik',nama='$nama',alamat = '$alamat',posisi='$posisi' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into karyawan (nik,nama,alamat,posisi) values ('$nik','$nama','$alamat','$posisi')";
            $q1 = mysqli_query($koneksi, $sql1);
             if ($q1) {
                $sukses     = "Berhasil membuat data baru";
            } else {
                $error      = "Gagal membuat data";
            }
        }
    } else {
        $error = "Silakan Buat data";
    }
}
?>
<!DOCTYPE html>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="posisi" id="posisi">
                                ...
                                <option value="staf" <?php if ($posisi == "staf") echo "selected" ?>>staf</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
